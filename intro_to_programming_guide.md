...
> the who
This guide is meant for everyone has little or no background in programming . But you would need some basic math understanding like addition, subtration, multiplication, division, and intro level algebra (e.g. can you solve x + 1 = 4 for x). Everything in this guide is free, except for

>the what
This path will will teach you the basics and foundamentals programming build blocks to learn more challenging tasks and projects like building websites, mobile apps, or computer programs that can recognize pictures. 

> how it is different from other learning guides?
